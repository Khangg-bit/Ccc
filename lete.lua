--[[
    ...
    Fix: GUI nhỏ gọn, tắt được danh sách người chơi
--]]
...
local function TeleportToTarget(target, useTween)
    ...
    if not useTween then
        ...
        if (rootPart.Position - finalPos).Magnitude < 5 then
            CreateNotification("✅ Đến: " .. target.Name, 2)
...
local function MinimizeMenu()
    ...
    -- Tắt danh sách người chơi nếu đang mở
    ClosePlayerList()
end
...
-- Hiển thị danh sách người chơi (có thể tắt)
function ShowPlayerList()
    ...
    -- Nút tắt nền mờ (click ra ngoài để tắt)
...
local function CreateMenu()
    ...
    -- Nút thu nhỏ    CreateButton(MainFrame, "📌 Thu nhỏ menu", btnY, 
...
-- Keybind ESC để tắt danh sách người chơi
UserInputService.InputBegan:Connect(function(input, gameProcessed)
    if gameProcessed then return end
...
task.delay(0.5, function()
    ...
    print("🖱️ Click icon để mở menu")
    print("❌ ESC = Tắt danh sách người chơi")
